...
#endif
{
    public static partial class Extensions
    {
        ...
        public static async Task<TResponse> ExecuteAsync<TResponse>(this IOrganizationServiceAsync2 service, OrganizationRequest request, CancellationToken cancellationToken = default) where TResponse: OrganizationResponse
        {
            ...
            {
                return (TResponse) await service.ExecuteAsync(request, cancellationToken);
            }
        }
        ...
        private static async Task<string?> GetEntityLogicalNameInternalAsync(this IOrganizationServiceAsync2 service, int objectTypeCode, CancellationToken token)
        {
            ...
            var response = await service.ExecuteAsync<RetrieveMetadataChangesResponse>(new RetrieveMetadataChangesRequest
            {
